...
$(function () {
    ...
    $(".collection").click(function () {
        var new_id = $(".collection").attr('data-newid')
        var action = 'collect'
        var params = {
            'new_id': new_id,
            'action': action
    ...
    $(".collected").click(function () {
        var new_id = $('.collected').attr('data-newid')
    ...
    $(".comment_form").submit(function (e) {
        e.preventDefault();
        var new_id = $('.comment_form').attr('data-newsid')
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.errno == '0') {
                    ...
                    comment_html += '<form class="reply_form fl" data-commentid="' + comment.id + '" data-newsid="' + new_id + '">'
